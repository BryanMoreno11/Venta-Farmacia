 ...
 * @author Daniel
 */
public class frmAdminCargo extends javax.swing.JFrame {

    /**
     * Creates new form frmAdminCargo
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro de cargo");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 540, 380));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 180, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 470, 180, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 470, 180, 30));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        frmInsertarCargo frm = new frmInsertarCargo("Insertar");
        frm.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jTable1.getSelectedRow()>=0){
            ...
            double suel = Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
            String desc = jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString();
            Cargo car = new Cargo(id, nombre, desc, suel);
            frmInsertarCargo frm = new frmInsertarCargo("Modificar");
            frm.SetDatos(car);
            frm.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Seleccione a un cargo a modificar", "Error", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            int res = JOptionPane.showConfirmDialog(null, "¿Esta seguro de eliminar?", "Confirmar", JOptionPane.YES_NO_OPTION);
            ...
            if (res == 0) {
                ...
                if (su == 0) {
                    ...
                    dao.EliminarCargo(car);
                    ListarDatos();
                }
            }
        } else {
            JOptionPane.showMessageDialog(null, "Seleccione un cargo a eliminar", "Error", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_jButton3ActionPerformed

    public static void ListarDatos(){
        CargoDAO ocd = new CargoDAO();
        List<Cargo> ListaCargo = ocd.ListarCargo();
        jTable1.setModel(ocd.MostrarTablaCargo(ListaCargo));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAdminCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAdminCargo().setVisible(true);
            }
        });
    }
